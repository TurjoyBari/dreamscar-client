    ...
    <main className="bg-background min-h-screen text-on-surface selection:bg-primary-container selection:text-on-primary-container">
      ...
      <section className="relative bg-surface-container-lowest py-20 overflow-hidden">
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10 text-center">
          <FadeUp>
            <h1 className="text-headline-lg font-headline-lg mb-4 text-on-surface uppercase tracking-tight">
              User Listing
            </h1>
      ...
      <section className="bg-surface-container-low border-b border-surface-container-highest sticky top-20 z-40">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop overflow-x-auto no-scrollbar">
          <div className="flex items-center justify-between min-w-max gap-4 py-6">
            <Link
              className="flex flex-col items-center gap-2 min-w-[100px] text-on-surface-variant hover:text-primary transition-all group"
              href="/dashboard"
            >
            ...
            <Link
              className="flex flex-col items-center gap-2 min-w-[100px] text-primary transition-all group"
              href="/dashboard"
            >
        ...
        <FadeUp delay={0.1}>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
            <div className="flex flex-wrap gap-2">
              <button className="px-6 py-2.5 rounded-full bg-primary-container text-on-primary-container font-bold text-label-md font-label-md hover:bg-[#e68900] transition-colors">
                All Listing
              </button>
              <button className="px-6 py-2.5 rounded-full bg-surface-container-high text-on-surface-variant hover:text-primary font-bold text-label-md font-label-md transition-colors">
                Upcoming
              </button>
              <button className="px-6 py-2.5 rounded-full bg-surface-container-high text-on-surface-variant hover:text-primary font-bold text-label-md font-label-md transition-colors">
                Inprogress
          ...
          <div className="bg-surface-container-low rounded-2xl border border-surface-container-highest overflow-hidden shadow-2xl">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead className="bg-surface-container-high/50 text-label-md font-label-md text-on-surface uppercase tracking-wider">
                  <tr>
                    <th className="px-6 py-5 w-12">
                      <input
                        className="rounded bg-surface-container-high border-outline text-primary focus:ring-primary"
                        type="checkbox"
                      />
                    </th>
                ...
                {cars?.map((car) => (
                  <tbody
                    key={car?._id}
                    className="divide-y divide-surface-container-highest"
                  >
                    {/* Row 1 */}
                    <tr className="hover:bg-surface-container-high/20 transition-colors group">
                      ...
                      <td className="px-6 py-6 font-bold text-primary group-hover:text-primary-container transition-colors">
                        #0808
                      </td>
                      <td className="px-6 py-6">
                      ...
                      <td className="px-6 py-6 text-sm text-on-surface-variant">
                        <CancelListingBtn listingId={car?._id} token={token} />
                      </td>
                      {/* <td className="px-6 py-6 text-sm text-on-surface-variant">
                        <Link href={`/update-listing/${car?._id}`}>
            ...
            <div className="p-6 border-t border-surface-container-highest flex flex-col sm:flex-row items-center justify-between gap-4 bg-surface-container-low">
              <div className="text-sm text-on-surface-variant">
                Showing{" "}
                <span className="text-on-surface font-bold">1 to 4</span> of{" "}
                <span className="text-on-surface font-bold">40</span> entries
              </div>
              <div className="flex items-center gap-2">
                ...
                <button className="w-10 h-10 rounded-lg bg-primary-container text-on-primary-container font-bold">
                  1
                </button>
                <button className="w-10 h-10 rounded-lg bg-surface-container-high text-on-surface-variant hover:text-primary transition-colors">
                  2
                </button>
                <button className="w-10 h-10 rounded-lg bg-surface-container-high text-on-surface-variant hover:text-primary transition-colors">
                  3
